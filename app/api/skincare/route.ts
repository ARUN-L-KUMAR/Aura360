...
const createSkincareSchema = z.object({
  ...
  category: z.string(),
  bodyPart: z.enum(["face", "hair", "body", "oral", "general"]).default("face"),
  status: z.enum(["owned", "need_to_buy", "finished"]).default("owned"),
  routineTime: z.enum(["morning", "evening", "both", "weekly", "optional"]).optional(),
  routineOrder: z.number().optional(),
